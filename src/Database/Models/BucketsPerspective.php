...
use NextDeveloper\S3\Database\Observers\BucketsPerspectiveObserver;
 ...
 * @property string $s3_server_hostname
 * @property string $s3_server_health
 * @property string $worm_status
 * @property \Carbon\Carbon $worm_locks_until
 * @property integer $active_webhook_count
 * @property integer $in_progress_uploads
 */
class BucketsPerspective extends Model
{
    ...
    protected $table = 's3_buckets_perspective';
    ...
    's3_server_hostname' => 'string',
    's3_server_health' => 'string',
    'worm_status' => 'string',
    'worm_locks_until' => 'datetime',
    'active_webhook_count' => 'integer',
    'in_progress_uploads' => 'integer',
    ];
    ...
    public static function boot()
    {
        ...
        parent::observe(BucketsPerspectiveObserver::class);
    ...
    public static function registerScopes()
    {
        ...
        $modelScopes = config('s3.scopes.s3_buckets_perspective');
