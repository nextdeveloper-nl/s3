...
class BucketsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\S3\Buckets', $model);
    }
    ...
    {
        Events::fire('created:NextDeveloper\S3\Buckets', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\S3\Buckets', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\S3\Buckets', $model);
    }
    ...
    public function updating(Model $model)
    {
        ...
        Events::fire('updating:NextDeveloper\S3\Buckets', $model);
    }
    ...
    {
        Events::fire('updated:NextDeveloper\S3\Buckets', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\S3\Buckets', $model);
    }
    ...
    {
        Events::fire('deleted:NextDeveloper\S3\Buckets', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\S3\Buckets', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\S3\Buckets', $model);
    }
