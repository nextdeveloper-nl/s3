 ...
 */
class AbstractDepositLedgersTransformer extends AbstractTransformer
{
    ...
    public function includeStates(DepositLedgers $model)
    {
    ...
    public function includeActions(DepositLedgers $model)
    {
    ...
    public function includeMedia(DepositLedgers $model)
    {
    ...
    public function includeSocialMedia(DepositLedgers $model)
    {
    ...
    public function includeComments(DepositLedgers $model)
    {
    ...
    public function includeVotes(DepositLedgers $model)
    {
    ...
    public function includeMeta(DepositLedgers $model)
    {
    ...
    public function includePhoneNumbers(DepositLedgers $model)
    {
    ...
    public function includeAddresses(DepositLedgers $model)
    {
