 ...
 */
class AbstractAccessKeysPerspectiveTransformer extends AbstractTransformer
{
    ...
    public function transform(AccessKeysPerspective $model)
    {
        ...
        return $this->buildPayload(
            ...
            'is_expiring_soon'  =>  $model->is_expiring_soon,
            ]
        );
    }

    public function includeStates(AccessKeysPerspective $model)
    {
    ...
    public function includeActions(AccessKeysPerspective $model)
    {
    ...
    public function includeMedia(AccessKeysPerspective $model)
    {
    ...
    public function includeSocialMedia(AccessKeysPerspective $model)
    {
    ...
    public function includeComments(AccessKeysPerspective $model)
    {
    ...
    public function includeVotes(AccessKeysPerspective $model)
    {
    ...
    public function includeMeta(AccessKeysPerspective $model)
    {
    ...
    public function includePhoneNumbers(AccessKeysPerspective $model)
    {
    ...
    public function includeAddresses(AccessKeysPerspective $model)
    {
