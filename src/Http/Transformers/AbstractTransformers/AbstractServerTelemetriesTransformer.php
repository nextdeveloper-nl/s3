 ...
 */
class AbstractServerTelemetriesTransformer extends AbstractTransformer
{
    ...
    public function includeStates(ServerTelemetries $model)
    {
    ...
    public function includeActions(ServerTelemetries $model)
    {
    ...
    public function includeMedia(ServerTelemetries $model)
    {
    ...
    public function includeSocialMedia(ServerTelemetries $model)
    {
    ...
    public function includeComments(ServerTelemetries $model)
    {
    ...
    public function includeVotes(ServerTelemetries $model)
    {
    ...
    public function includeMeta(ServerTelemetries $model)
    {
    ...
    public function includePhoneNumbers(ServerTelemetries $model)
    {
    ...
    public function includeAddresses(ServerTelemetries $model)
    {
