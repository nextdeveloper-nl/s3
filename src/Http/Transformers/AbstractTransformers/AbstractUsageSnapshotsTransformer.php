 ...
 */
class AbstractUsageSnapshotsTransformer extends AbstractTransformer
{
    ...
    public function includeStates(UsageSnapshots $model)
    {
    ...
    public function includeActions(UsageSnapshots $model)
    {
    ...
    public function includeMedia(UsageSnapshots $model)
    {
    ...
    public function includeSocialMedia(UsageSnapshots $model)
    {
    ...
    public function includeComments(UsageSnapshots $model)
    {
    ...
    public function includeVotes(UsageSnapshots $model)
    {
    ...
    public function includeMeta(UsageSnapshots $model)
    {
    ...
    public function includePhoneNumbers(UsageSnapshots $model)
    {
    ...
    public function includeAddresses(UsageSnapshots $model)
    {
