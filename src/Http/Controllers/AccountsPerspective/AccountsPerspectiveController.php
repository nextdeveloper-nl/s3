...
namespace NextDeveloper\S3\Http\Controllers\AccountsPerspective;

use Illuminate\Http\Request;
use NextDeveloper\S3\Http\Controllers\AbstractController;
use NextDeveloper\Commons\Http\Response\ResponsableFactory;
use NextDeveloper\S3\Http\Requests\AccountsPerspective\AccountsPerspectiveUpdateRequest;
use NextDeveloper\S3\Database\Filters\AccountsPerspectiveQueryFilter;
use NextDeveloper\S3\Database\Models\AccountsPerspective;
use NextDeveloper\S3\Services\AccountsPerspectiveService;
use NextDeveloper\S3\Http\Requests\AccountsPerspective\AccountsPerspectiveCreateRequest;
